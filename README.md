...
1.Меняем строчку с главного экрана "В других регионах есть заманчивое предложение" на "Гарантия на потолки 10 лет"
2.Ставим цену на главном экране от 80 рублей кв м
...
5.В разделе "Наши возможности" меняем текст после фразы "Если кратко - можем все" на "Соблюдаем оговоренные сроки, дата и время монтажа назначается клиентом(работаем хоть ночью), предлагаем обслуживание потолков после потопов или других случаев вплоть до изменения дизайна помещения,гарантия на потолки 10 лет. Так же есть сопутсвующие услуги от сертифицированных специалистов :
...
7.номер телефона 8 495 506 93 69Адрес Хабаровская 6 корпус 2 помещение 185
8.Валидатор
9.Освещение
